...
logger = get_logger("mongodb_cardinality_benchmark", readbench_config["general"]["log_file"])
...
for cfg in CARDINALITY_LEVELS:
    for run_num in range(1, NUMBER_OF_REPEATS + 1):
        results, elapsed_ns = mongodb_repo.query_cardinality(
...
print("MongoDB cardinality benchmark complete.")
