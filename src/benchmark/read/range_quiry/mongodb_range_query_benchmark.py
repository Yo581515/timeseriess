...
logger = get_logger("mongodb_range_query_benchmark", readbench_config["general"]["log_file"])
...
for parameter in PARAMETERS:
    for window_name, window in RANGE_WINDOWS.items():
        ...
        for run_num in range(1, NUMBER_OF_REPEATS + 1):
            results, elapsed_ns = mongodb_repo.query_range(parameter, start_time, end_time)
...
print("MongoDB range-query benchmark complete.")
