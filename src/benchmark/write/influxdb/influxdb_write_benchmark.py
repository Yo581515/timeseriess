...
influxdb_config_dict = load_config("./configs/config-influxdb.yml")
logger = get_logger("influxdb_write_benchmark", influxdb_config_dict["general"]["log_file"])
influxdb_repo = InfluxRepo(get_influxdb_config(influxdb_config_dict["database"]), logger)
